...
STATIC_ASSET_VERSION = os.getenv("STATIC_ASSET_VERSION", "20260718-interval-zero-v2")
MEDIA_URL = "/media/"
...
WASENDER_MIN_SEND_INTERVAL_SECONDS = 0
WASENDER_MAX_SEND_INTERVAL_SECONDS = 3600
WASENDER_SEND_INTERVAL_SECONDS = int(os.getenv("WASENDER_SEND_INTERVAL_SECONDS", "1"))
