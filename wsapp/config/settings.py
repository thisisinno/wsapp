...
# Wasender account protection permits one send every five seconds at most.
WASENDER_MIN_SEND_INTERVAL_SECONDS = 5
WASENDER_SEND_INTERVAL_SECONDS = max(
    WASENDER_MIN_SEND_INTERVAL_SECONDS,
    int(os.getenv("WASENDER_SEND_INTERVAL_SECONDS", "5")),
)
